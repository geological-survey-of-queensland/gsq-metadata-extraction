...
def main():
    ...
    save_path = "H:/gsq-metadata-extraction/tensorflow-training/Seq2Seq Example/models"
    checkpoint_file = tf.train.latest_checkpoint(save_path)
    graph = tf.Graph()
    print(save_path, checkpoint_file)
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            print(sess.run(prediction, feed_dict={inputs:source_ints}))
